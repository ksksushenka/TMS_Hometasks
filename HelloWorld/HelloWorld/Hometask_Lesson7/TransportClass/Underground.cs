...
namespace TMS_Hometasks.Hometask_Lesson7.TransportClass
{
    ...
    {
        public Underground(string destination, int transportNumber, string timeOfTransport, int numberOfSeats) : base(destination, transportNumber, timeOfTransport, numberOfSeats)
        {
        }
        ...
        {
            Console.WriteLine($"This {TransportNumber} underground goes to the {Destination} at {TimeOfTransport} and has {NumberOfSeats} numbers of seats.");
        }
    }
}
